...
func main() {
	...
	/* Firma de una funcion (%T formatea la Firma de una funcion)
	Notar que la funcion no se llama (no se escribieron con parentesis),
	sino que a Println() se le esta pasando la definicion de la funcion en si
	*/
